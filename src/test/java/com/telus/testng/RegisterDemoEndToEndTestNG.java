...
public class RegisterDemoEndToEndTestNG {
	...
	// Committed by bhagwan singh gor CI-CD implimentation 03/oct/2022 4:43
	...
	public void launchApplication() {
		...
		System.out.println("Application url is Successfully Launched");
		System.out.println("========================================================");
	...
	public void validateTitle() {
		...
		if(actRegTitleText.equals(expRegTitleText)) { 
			System.out.println("The Registration Title of the page is successfully validated");
	...
	public void registerUser() {
		...
		if(firstName.isEnabled()) {
			...
			System.out.println("First Name input field is not enabled");
		...
		if(streetAddress.isEnabled()) {
			...
			System.out.println("Street Address input field is not enabled");
		...
		if(building.isEnabled()) {
			...
			System.out.println("Building input field is enabled");

			// Enter the Address2/building 
			building.sendKeys(buildingValue);
			System.out.println("Address2/Building field value is : " + buildingValue);

		}
		else{

			System.out.println("Building input field is not enabled");
		...
		if(city.isEnabled()) {
			...
			System.out.println("City input field is enabled");

			// Enter the City 
			city.sendKeys(cityValue);
			System.out.println("City field value is : " + cityValue);
		}
		else{

			System.out.println("City input field is not enabled");
		...
		if(state.isEnabled()) {
			...
			System.out.println("State input field is enabled");

			// Enter the State 
			state.sendKeys(stateValue);
			System.out.println("State field value is : " + stateValue);

		}
		else{

			System.out.println("State input field is not enabled");
		...
		if(zipCode.isEnabled()) {
			...
			System.out.println("ZipCode input field is enabled");

			// Enter the zipCode  
			zipCode.sendKeys(zipCodeValue);
			System.out.println("ZipCode field value is : " + zipCodeValue);

		}
		else{

			System.out.println("ZipCode input field is not enabled");
		}
		...
		if(eMail.isEnabled()) {
			...
			System.out.println("E Mail input field is enabled");

			// Enter the E Mail  
			eMail.sendKeys(eMailValue);
			System.out.println("E Mail field value is : " + eMailValue);
		}
		else {

			System.out.println("E Mail input field is not enabled");
		}
		...
		if(dateOfDemo.isEnabled()) {
			...
			System.out.println("DateOfDemo input field is enabled");

			// Enter the  dateOfDemo  
			dateOfDemo.sendKeys(dateOfDemoValue);
			System.out.println("DateOfDemo field value is : " + dateOfDemoValue);
		}
		else {

			System.out.println("dateOfDemo input field is not enabled");
		}
		...
		if(mobileNumber.isEnabled()) {
			...
			System.out.println("mobileNumber input field is enabled");

			// Enter the mobileNumber  
			mobileNumber.sendKeys(mobileNumberValue);
			System.out.println("Mobile Number field value is : " + mobileNumberValue);
		...
		if(query.isEnabled()) {
			...
			System.out.println("Query field value is : " + queryValue);
		...
		if(verificationNoField.isEnabled()) {
			...
			System.out.println("Verification no input Field is Enabled ");

			// Pass the trimmed value to the "verificationNoField"
			verificationNoField.sendKeys(verificationNumber);

			System.out.println("Verification no value is : "+verificationNumber);

		}
		else {

			System.out.println("Verification no input Field is not Enabled ");
